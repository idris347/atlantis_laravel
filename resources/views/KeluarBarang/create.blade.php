  ...
  <div class="page-inner py-4">
    <div class="page-header text-white">
      ...
      <ul class="breadcrumbs">
        ...
        <li class="nav-item"><a href="{{ route('barang_keluar') }}" class="text-white">Barang Keluar</a></li>
        <li class="separator"><i class="flaticon-right-arrow"></i></li>
  ...
  <div class="card">
    ...
    <form action="modules/barang-keluar/proses_entri.php" method="post" class="needs-validation" novalidate>
        ...
        <div class="row">
          <div class="col-md-7">
            <div class="form-group">
              ...
              <input type="text" name="id_transaksi" class="form-control" value="TK-0000001" readonly>
            </div>
          </div>
      ...
      <div class="card-action">
        ...
        <a href="{{ route('barang_keluar') }}" class="btn btn-default btn-round pl-4 pr-4">Batal</a>
      </div>
    </form>
  </div>
</div>
